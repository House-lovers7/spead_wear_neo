...
# SPEAD WEAR - Shazam for Fashion Snap — 見積り（オンボーディング・契約確認）
...
| API契約確認（4件） | 2h | 4h | `src/app/api/analyze/route.ts` | auth/input/output/errorをtestまたはOpenAPIへ固定 |
| 画面状態確認（5 screen） | 2h | 4h | `src/app/page.tsx` | 主要状態と導線をsmoke/testで確認 |
